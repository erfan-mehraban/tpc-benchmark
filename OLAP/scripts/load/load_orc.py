...
sc = pyspark.SparkContext(appName="load_orc")
...
data_frame = data\
            ...
            .toDF(schema)
data_frame.write.mode("overwrite").orc("hdfs://namenode:8020/region.orc")
...
data_frame = data\
            ...
            .toDF(schema)
data_frame.write.mode("overwrite").orc("hdfs://namenode:8020/nation.orc")
...
data_frame = data\
            ...
            .toDF(schema)
data_frame.write.mode("overwrite").orc("hdfs://namenode:8020/supplier.orc")
...
data_frame = data\
            ...
            .toDF(schema)
data_frame.write.mode("overwrite").orc("hdfs://namenode:8020/part.orc")
...
data_frame = data\
            ...
            .toDF(schema)
data_frame.write.mode("overwrite").orc("hdfs://namenode:8020/customer.orc")
...
data_frame = data\
            ...
            .toDF(schema)
data_frame.write.mode("overwrite").orc("hdfs://namenode:8020/partsupp.orc")
...
data_frame = data\
            ...
            .toDF(schema)
data_frame.write.mode("overwrite").orc("hdfs://namenode:8020/orders.orc")
...
data_frame = data\
            ...
            .toDF(schema)
data_frame.write.mode("overwrite").orc("hdfs://namenode:8020/lineitem.orc")
